...
/* ******************************************************************************
   ...
   **************************************************************************** */
#define EW_PLATFORM_STRING    "SAM9x75-Curiosity-WVGA"
...
#define RTC_DEFAULT_TIME      1669042800     /* 2022-11-21 15:00 */
...
#define EW_DISPLAY_WIDTH                    720
#define EW_DISPLAY_HEIGHT                   720

#define EW_FRAME_BUFFER_WIDTH           720
#define EW_FRAME_BUFFER_HEIGHT          720
/* calculated addresses for framebuffer(s) */
#define EW_FRAME_BUFFER_ADDR  0x25000000
#define EW_FRAME_BUFFER_SIZE  EW_FRAME_BUFFER_WIDTH * EW_FRAME_BUFFER_HEIGHT * EW_FRAME_BUFFER_DEPTH
#define EW_FRAME_BUFFER_COLOR_FORMAT EW_FRAME_BUFFER_COLOR_FORMAT_RGBA8888
#if EW_USE_DOUBLE_BUFFER == 1

  #define EW_DOUBLE_BUFFER_ADDR  0x25200000
...
#define EW_TOUCH_AREA_MAX_X                    720
#define EW_TOUCH_AREA_MAX_Y                    720
...
/* ******************************************************************************
   ...
   **************************************************************************** */
//#define EW_MEMORY_POOL_ADDR      (GFX_GLCD_LAYER0_DBL_BASEADDR + EW_FRAME_BUFFER_SIZE)
#define EW_MEMORY_POOL_ADDR      (0x26000000)
...
/* ******************************************************************************
   ...
   **************************************************************************** */
#define EW_MAX_STRING_CACHE_SIZE      0x2000
