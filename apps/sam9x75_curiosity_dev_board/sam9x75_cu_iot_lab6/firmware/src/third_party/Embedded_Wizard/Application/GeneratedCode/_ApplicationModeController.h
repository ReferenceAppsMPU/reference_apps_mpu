...
#ifndef _ApplicationModeController_H
#define _ApplicationModeController_H
...
/* Forward declaration of the class Application::ModeController */
#ifndef _ApplicationModeController_
  EW_DECLARE_CLASS( ApplicationModeController )
#define _ApplicationModeController_
#endif
...
/* Deklaration of class : 'Application::ModeController' */
EW_DEFINE_FIELDS( ApplicationModeController, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationModeController )

/* Virtual Method Table (VMT) for the class : 'Application::ModeController' */
EW_DEFINE_METHODS( ApplicationModeController, CoreGroup )
...
EW_END_OF_METHODS( ApplicationModeController )
...
#endif /* _ApplicationModeController_H */
