...
unsigned long EwBspClockGetTime( void )
{
  ...
  unsigned long   days;
  unsigned long   year   = rtcTime.tm_year - 100;
  unsigned long   month  = rtcTime.tm_mon + 1;
  unsigned long   day    = rtcTime.tm_mday;
  unsigned long   hour   = rtcTime.tm_hour;
  unsigned long   minute = rtcTime.tm_min;
  unsigned long   second = rtcTime.tm_sec;
