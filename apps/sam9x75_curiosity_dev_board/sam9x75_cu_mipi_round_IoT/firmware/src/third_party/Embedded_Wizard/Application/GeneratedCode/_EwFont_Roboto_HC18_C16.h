...
EW_DEFINE_BITMAP_FONT( EwFont_Roboto_HC18_C16, 14, 4, 0, 16 )
  EW_FONT_GLYPH( 0x0000, 0, -11, 7, 11, 7, 0x00000000 ),
  EW_FONT_GLYPH( 0x0020, 0, 0, 0, 0, 4, 0x000000F7 ),                  /* ' ' */
  EW_FONT_GLYPH( 0x0021, 1, -11, 2, 11, 4, 0x000000F7 ),               /* '!' */
  EW_FONT_GLYPH( 0x0022, 1, -11, 3, 4, 5, 0x00000136 ),                /* '"' */
  EW_FONT_GLYPH( 0x0023, 0, -11, 9, 11, 9, 0x00000157 ),               /* '#' */
  EW_FONT_GLYPH( 0x0024, 0, -13, 8, 15, 8, 0x000002AD ),               /* '$' */
  EW_FONT_GLYPH( 0x0025, 0, -11, 11, 11, 11, 0x00000446 ),             /* '%' */
  EW_FONT_GLYPH( 0x0026, 0, -11, 10, 11, 9, 0x000005EB ),              /* '&' */
  EW_FONT_GLYPH( 0x0027, 0, -11, 2, 3, 3, 0x00000768 ),                /* ''' */
  EW_FONT_GLYPH( 0x0028, 1, -12, 4, 15, 5, 0x0000077C ),               /* '(' */
  EW_FONT_GLYPH( 0x0029, 0, -12, 5, 15, 5, 0x00000842 ),               /* ')' */
  EW_FONT_GLYPH( 0x002A, 0, -11, 7, 7, 6, 0x00000916 ),                /* '*' */
  EW_FONT_GLYPH( 0x002B, 0, -10, 8, 9, 9, 0x000009CA ),                /* '+' */
  EW_FONT_GLYPH( 0x002C, 0, -2, 3, 4, 3, 0x00000A69 ),                 /* ',' */
  EW_FONT_GLYPH( 0x002D, 0, -5, 4, 1, 4, 0x00000A93 ),                 /* '-' */
  EW_FONT_GLYPH( 0x002E, 1, -2, 2, 2, 4, 0x00000AAB ),                 /* '.' */
  EW_FONT_GLYPH( 0x002F, 0, -11, 6, 12, 6, 0x00000AB8 ),               /* '/' */
  EW_FONT_GLYPH( 0x0030, 0, -11, 8, 11, 8, 0x00000B78 ),               /* '0' */
  EW_FONT_GLYPH( 0x0031, 1, -11, 5, 11, 8, 0x00000C7B ),               /* '1' */
  EW_FONT_GLYPH( 0x0032, 0, -11, 8, 11, 8, 0x00000CE5 ),               /* '2' */
  EW_FONT_GLYPH( 0x0033, 0, -11, 8, 11, 8, 0x00000E11 ),               /* '3' */
  EW_FONT_GLYPH( 0x0034, 0, -11, 9, 11, 8, 0x00000F3D ),               /* '4' */
  EW_FONT_GLYPH( 0x0035, 1, -11, 7, 11, 8, 0x0000102B ),               /* '5' */
  EW_FONT_GLYPH( 0x0036, 1, -11, 7, 11, 8, 0x00001151 ),               /* '6' */
  EW_FONT_GLYPH( 0x0037, 0, -11, 8, 11, 8, 0x00001283 ),               /* '7' */
  EW_FONT_GLYPH( 0x0038, 0, -11, 8, 11, 8, 0x0000137E ),               /* '8' */
  EW_FONT_GLYPH( 0x0039, 0, -11, 8, 11, 8, 0x000014BE ),               /* '9' */
  EW_FONT_GLYPH( 0x003A, 1, -8, 2, 8, 4, 0x000015F7 ),                 /* ':' */
  EW_FONT_GLYPH( 0x003B, 0, -8, 3, 10, 3, 0x00001622 ),                /* ';' */
  EW_FONT_GLYPH( 0x003C, 0, -8, 7, 7, 8, 0x00001670 ),                 /* '<' */
  EW_FONT_GLYPH( 0x003D, 1, -7, 7, 4, 8, 0x0000172F ),                 /* '=' */
  EW_FONT_GLYPH( 0x003E, 1, -8, 7, 7, 8, 0x000017A5 ),                 /* '>' */
  EW_FONT_GLYPH( 0x003F, 0, -11, 7, 11, 7, 0x00001865 ),               /* '?' */
  EW_FONT_GLYPH( 0x0040, 0, -10, 13, 13, 13, 0x00001951 ),             /* '@' */
  EW_FONT_GLYPH( 0x0041, 0, -11, 10, 11, 10, 0x00001BB2 ),             /* 'A' */
  EW_FONT_GLYPH( 0x0042, 1, -11, 8, 11, 9, 0x00001D01 ),               /* 'B' */
  EW_FONT_GLYPH( 0x0043, 0, -11, 10, 11, 10, 0x00001E0C ),             /* 'C' */
  EW_FONT_GLYPH( 0x0044, 1, -11, 8, 11, 10, 0x00001F58 ),              /* 'D' */
  EW_FONT_GLYPH( 0x0045, 1, -11, 7, 11, 9, 0x0000204C ),               /* 'E' */
  EW_FONT_GLYPH( 0x0046, 1, -11, 7, 11, 8, 0x00002117 ),               /* 'F' */
  EW_FONT_GLYPH( 0x0047, 0, -11, 10, 11, 10, 0x000021CC ),             /* 'G' */
  EW_FONT_GLYPH( 0x0048, 1, -11, 9, 11, 11, 0x0000231B ),              /* 'H' */
  EW_FONT_GLYPH( 0x0049, 1, -11, 2, 11, 4, 0x000023C1 ),               /* 'I' */
  EW_FONT_GLYPH( 0x004A, 0, -11, 8, 11, 8, 0x000023E2 ),               /* 'J' */
  EW_FONT_GLYPH( 0x004B, 1, -11, 9, 11, 9, 0x00002496 ),               /* 'K' */
  EW_FONT_GLYPH( 0x004C, 1, -11, 7, 11, 8, 0x000025AC ),               /* 'L' */
  EW_FONT_GLYPH( 0x004D, 1, -11, 11, 11, 13, 0x0000261E ),             /* 'M' */
  EW_FONT_GLYPH( 0x004E, 1, -11, 9, 11, 11, 0x0000276E ),              /* 'N' */
  EW_FONT_GLYPH( 0x004F, 0, -11, 10, 11, 10, 0x00002857 ),             /* 'O' */
  EW_FONT_GLYPH( 0x0050, 1, -11, 8, 11, 9, 0x000029A9 ),               /* 'P' */
  EW_FONT_GLYPH( 0x0051, 0, -11, 10, 13, 10, 0x00002A98 ),             /* 'Q' */
  EW_FONT_GLYPH( 0x0052, 1, -11, 8, 11, 9, 0x00002C29 ),               /* 'R' */
  EW_FONT_GLYPH( 0x0053, 0, -11, 9, 11, 9, 0x00002D2C ),               /* 'S' */
  EW_FONT_GLYPH( 0x0054, 0, -11, 9, 11, 9, 0x00002EA1 ),               /* 'T' */
  EW_FONT_GLYPH( 0x0055, 1, -11, 8, 11, 10, 0x00002F4C ),              /* 'U' */
  EW_FONT_GLYPH( 0x0056, 0, -11, 10, 11, 10, 0x0000300F ),             /* 'V' */
  EW_FONT_GLYPH( 0x0057, 0, -11, 13, 11, 13, 0x0000316A ),             /* 'W' */
  EW_FONT_GLYPH( 0x0058, 0, -11, 9, 11, 9, 0x0000334C ),               /* 'X' */
  EW_FONT_GLYPH( 0x0059, 0, -11, 9, 11, 9, 0x0000349F ),               /* 'Y' */
  EW_FONT_GLYPH( 0x005A, 0, -11, 9, 11, 9, 0x00003593 ),               /* 'Z' */
  EW_FONT_GLYPH( 0x005B, 1, -12, 3, 14, 4, 0x000036CA ),               /* '[' */
  EW_FONT_GLYPH( 0x005C, 0, -11, 6, 12, 6, 0x00003714 ),               /* '\' */
  EW_FONT_GLYPH( 0x005D, 0, -12, 3, 14, 4, 0x000037DC ),               /* ']' */
  EW_FONT_GLYPH( 0x005E, 0, -11, 6, 5, 6, 0x00003822 ),                /* '^' */
  EW_FONT_GLYPH( 0x005F, 0, 0, 7, 1, 7, 0x0000388C ),                  /* '_' */
  EW_FONT_GLYPH( 0x0060, 0, -11, 4, 2, 5, 0x000038B1 ),                /* '`' */
  EW_FONT_GLYPH( 0x0061, 0, -8, 8, 8, 8, 0x000038D2 ),                 /* 'a' */
  EW_FONT_GLYPH( 0x0062, 0, -11, 8, 11, 8, 0x000039C0 ),               /* 'b' */
  EW_FONT_GLYPH( 0x0063, 0, -8, 8, 8, 8, 0x00003A9E ),                 /* 'c' */
  EW_FONT_GLYPH( 0x0064, 0, -11, 8, 11, 8, 0x00003B7A ),               /* 'd' */
  EW_FONT_GLYPH( 0x0065, 0, -8, 8, 8, 8, 0x00003C57 ),                 /* 'e' */
  EW_FONT_GLYPH( 0x0066, 0, -11, 6, 11, 5, 0x00003D4D ),               /* 'f' */
  EW_FONT_GLYPH( 0x0067, 0, -8, 8, 11, 8, 0x00003DE0 ),                /* 'g' */
  EW_FONT_GLYPH( 0x0068, 0, -11, 8, 11, 8, 0x00003F0A ),               /* 'h' */
  EW_FONT_GLYPH( 0x0069, 1, -11, 2, 11, 4, 0x00003FA9 ),               /* 'i' */
  EW_FONT_GLYPH( 0x006A, -1, -11, 4, 14, 4, 0x00003FDE ),              /* 'j' */
  EW_FONT_GLYPH( 0x006B, 1, -11, 7, 11, 8, 0x00004045 ),               /* 'k' */
  EW_FONT_GLYPH( 0x006C, 1, -11, 2, 11, 4, 0x00004111 ),               /* 'l' */
  EW_FONT_GLYPH( 0x006D, 1, -8, 12, 8, 13, 0x00004131 ),               /* 'm' */
  EW_FONT_GLYPH( 0x006E, 0, -8, 8, 8, 8, 0x0000421A ),                 /* 'n' */
  EW_FONT_GLYPH( 0x006F, 0, -8, 9, 8, 9, 0x000042A0 ),                 /* 'o' */
  EW_FONT_GLYPH( 0x0070, 0, -8, 8, 11, 8, 0x000043A0 ),                /* 'p' */
  EW_FONT_GLYPH( 0x0071, 0, -8, 8, 11, 9, 0x000044A3 ),                /* 'q' */
  EW_FONT_GLYPH( 0x0072, 1, -8, 4, 8, 5, 0x00004598 ),                 /* 'r' */
  EW_FONT_GLYPH( 0x0073, 0, -8, 8, 8, 8, 0x000045DD ),                 /* 's' */
  EW_FONT_GLYPH( 0x0074, 0, -10, 5, 10, 5, 0x000046E2 ),               /* 't' */
  EW_FONT_GLYPH( 0x0075, 0, -8, 8, 8, 8, 0x00004762 ),                 /* 'u' */
  EW_FONT_GLYPH( 0x0076, 0, -8, 7, 8, 7, 0x000047E2 ),                 /* 'v' */
  EW_FONT_GLYPH( 0x0077, 0, -8, 11, 8, 11, 0x000048A1 ),               /* 'w' */
  EW_FONT_GLYPH( 0x0078, 0, -8, 8, 8, 7, 0x000049E2 ),                 /* 'x' */
  EW_FONT_GLYPH( 0x0079, 0, -8, 7, 11, 7, 0x00004AC6 ),                /* 'y' */
  EW_FONT_GLYPH( 0x007A, 0, -8, 7, 8, 7, 0x00004BC7 ),                 /* 'z' */
  EW_FONT_GLYPH( 0x007B, 0, -12, 5, 15, 5, 0x00004C9C ),               /* '{' */
  EW_FONT_GLYPH( 0x007C, 1, -11, 2, 13, 4, 0x00004D72 ),               /* '|' */
  EW_FONT_GLYPH( 0x007D, 0, -12, 5, 15, 5, 0x00004D97 ),               /* '}' */
  EW_FONT_GLYPH( 0x007E, 0, -6, 10, 3, 10, 0x00004E65 ),               /* '~' */
  EW_FONT_GLYPH( 0x00A0, 0, 0, 0, 0, 4, 0x00004EDC ),
  EW_FONT_GLYPH( 0x00A1, 1, -8, 2, 11, 4, 0x00004EDC ),
  EW_FONT_GLYPH( 0x00A2, 0, -10, 8, 12, 8, 0x00004F1B ),
  EW_FONT_GLYPH( 0x00A3, 0, -11, 9, 11, 9, 0x00005046 ),
  EW_FONT_GLYPH( 0x00A4, 0, -10, 11, 11, 11, 0x00005164 ),
  EW_FONT_GLYPH( 0x00A5, 0, -11, 9, 11, 9, 0x00005303 ),
  EW_FONT_GLYPH( 0x00A6, 1, -11, 2, 13, 4, 0x00005440 ),
  EW_FONT_GLYPH( 0x00A7, 0, -11, 9, 15, 9, 0x00005478 ),
  EW_FONT_GLYPH( 0x00A8, 0, -11, 6, 2, 6, 0x00005671 ),
  EW_FONT_GLYPH( 0x00A9, 0, -11, 12, 11, 12, 0x00005693 ),
  EW_FONT_GLYPH( 0x00AA, 1, -11, 5, 6, 7, 0x0000588D ),
  EW_FONT_GLYPH( 0x00AB, 0, -7, 6, 6, 7, 0x00005913 ),
  EW_FONT_GLYPH( 0x00AC, 0, -6, 7, 3, 8, 0x000059A7 ),
  EW_FONT_GLYPH( 0x00AD, 0, -5, 4, 1, 4, 0x000059EF ),
  EW_FONT_GLYPH( 0x00AE, 0, -11, 12, 11, 12, 0x00005A07 ),
  EW_FONT_GLYPH( 0x00AF, 0, -11, 7, 1, 7, 0x00005BD0 ),
  EW_FONT_GLYPH( 0x00B0, 1, -11, 4, 4, 6, 0x00005BF1 ),
  EW_FONT_GLYPH( 0x00B1, 0, -9, 8, 9, 8, 0x00005C36 ),
  EW_FONT_GLYPH( 0x00B2, 0, -11, 6, 6, 6, 0x00005CEB ),
  EW_FONT_GLYPH( 0x00B3, 0, -11, 6, 6, 6, 0x00005D7A ),
  EW_FONT_GLYPH( 0x00B4, 0, -11, 4, 2, 5, 0x00005E01 ),
  EW_FONT_GLYPH( 0x00B5, 1, -8, 7, 11, 9, 0x00005E21 ),
  EW_FONT_GLYPH( 0x00B6, 0, -11, 6, 11, 7, 0x00005EC7 ),
  EW_FONT_GLYPH( 0x00B7, 1, -6, 2, 2, 4, 0x00005F65 ),
  EW_FONT_GLYPH( 0x00B8, 1, 0, 3, 3, 4, 0x00005F73 ),
  EW_FONT_GLYPH( 0x00B9, 1, -11, 3, 6, 6, 0x00005FA0 ),
  EW_FONT_GLYPH( 0x00BA, 1, -11, 5, 6, 7, 0x00005FD9 ),
  EW_FONT_GLYPH( 0x00BB, 0, -7, 7, 6, 7, 0x00006061 ),
  EW_FONT_GLYPH( 0x00BC, 0, -11, 11, 11, 11, 0x000060F7 ),
  EW_FONT_GLYPH( 0x00BD, 0, -11, 12, 11, 12, 0x00006259 ),
  EW_FONT_GLYPH( 0x00BE, 0, -11, 12, 11, 12, 0x000063D9 ),
  EW_FONT_GLYPH( 0x00BF, 0, -8, 7, 11, 7, 0x0000659F ),
  EW_FONT_GLYPH( 0x00C0, 0, -14, 10, 14, 10, 0x0000667A ),
  EW_FONT_GLYPH( 0x00C1, 0, -14, 10, 14, 10, 0x0000680B ),
  EW_FONT_GLYPH( 0x00C2, 0, -14, 10, 14, 10, 0x00006999 ),
  EW_FONT_GLYPH( 0x00C3, 0, -14, 10, 15, 10, 0x00006B3A ),
  EW_FONT_GLYPH( 0x00C4, 0, -14, 10, 14, 10, 0x00006CE8 ),
  EW_FONT_GLYPH( 0x00C5, 0, -14, 10, 15, 10, 0x00006E81 ),
  EW_FONT_GLYPH( 0x00C6, -1, -11, 15, 11, 14, 0x0000702B ),
  EW_FONT_GLYPH( 0x00C7, 0, -11, 10, 14, 10, 0x000071EB ),
  EW_FONT_GLYPH( 0x00C8, 1, -14, 7, 14, 9, 0x00007389 ),
  EW_FONT_GLYPH( 0x00C9, 1, -14, 7, 14, 9, 0x0000748D ),
  EW_FONT_GLYPH( 0x00CA, 1, -14, 7, 14, 9, 0x0000758E ),
  EW_FONT_GLYPH( 0x00CB, 1, -14, 7, 14, 9, 0x000076A2 ),
  EW_FONT_GLYPH( 0x00CC, -1, -14, 4, 14, 4, 0x000077AE ),
  EW_FONT_GLYPH( 0x00CD, 0, -14, 4, 14, 4, 0x00007815 ),
  EW_FONT_GLYPH( 0x00CE, 0, -14, 5, 14, 4, 0x00007879 ),
  EW_FONT_GLYPH( 0x00CF, -1, -14, 6, 14, 4, 0x000078FE ),
  EW_FONT_GLYPH( 0x00D0, 0, -11, 10, 11, 10, 0x00007989 ),
  EW_FONT_GLYPH( 0x00D1, 1, -14, 9, 15, 11, 0x00007AB3 ),
  EW_FONT_GLYPH( 0x00D2, 0, -14, 10, 14, 10, 0x00007BF7 ),
  EW_FONT_GLYPH( 0x00D3, 0, -14, 10, 14, 10, 0x00007D8B ),
  EW_FONT_GLYPH( 0x00D4, 0, -14, 10, 14, 10, 0x00007F1C ),
  EW_FONT_GLYPH( 0x00D5, 0, -14, 10, 15, 10, 0x000080C0 ),
  EW_FONT_GLYPH( 0x00D6, 0, -14, 10, 14, 10, 0x00008271 ),
  EW_FONT_GLYPH( 0x00D7, 0, -8, 8, 7, 8, 0x0000840D ),
  EW_FONT_GLYPH( 0x00D8, 0, -12, 10, 13, 10, 0x000084D2 ),
  EW_FONT_GLYPH( 0x00D9, 1, -14, 8, 14, 10, 0x00008695 ),
  EW_FONT_GLYPH( 0x00DA, 1, -14, 8, 14, 10, 0x00008794 ),
  EW_FONT_GLYPH( 0x00DB, 1, -14, 8, 14, 10, 0x00008890 ),
  EW_FONT_GLYPH( 0x00DC, 1, -14, 8, 14, 10, 0x0000899F ),
  EW_FONT_GLYPH( 0x00DD, 0, -14, 9, 14, 9, 0x00008AA6 ),
  EW_FONT_GLYPH( 0x00DE, 1, -11, 8, 11, 9, 0x00008BD6 ),
  EW_FONT_GLYPH( 0x00DF, 1, -11, 8, 11, 9, 0x00008CB7 ),
  EW_FONT_GLYPH( 0x00E0, 0, -11, 8, 11, 8, 0x00008DC7 ),
  EW_FONT_GLYPH( 0x00E1, 0, -11, 8, 11, 8, 0x00008EF1 ),
  EW_FONT_GLYPH( 0x00E2, 0, -11, 8, 11, 8, 0x00009018 ),
  EW_FONT_GLYPH( 0x00E3, 0, -12, 8, 12, 8, 0x00009152 ),
  EW_FONT_GLYPH( 0x00E4, 0, -11, 8, 11, 8, 0x00009297 ),
  EW_FONT_GLYPH( 0x00E5, 0, -12, 8, 12, 8, 0x000093C9 ),
  EW_FONT_GLYPH( 0x00E6, 0, -8, 13, 8, 13, 0x0000950A ),
  EW_FONT_GLYPH( 0x00E7, 0, -8, 8, 11, 8, 0x000096AF ),
  EW_FONT_GLYPH( 0x00E8, 0, -11, 8, 11, 8, 0x000097D3 ),
  EW_FONT_GLYPH( 0x00E9, 0, -11, 8, 11, 8, 0x00009905 ),
  EW_FONT_GLYPH( 0x00EA, 0, -11, 8, 11, 8, 0x00009A34 ),
  EW_FONT_GLYPH( 0x00EB, 0, -11, 8, 11, 8, 0x00009B76 ),
  EW_FONT_GLYPH( 0x00EC, -1, -11, 4, 11, 4, 0x00009CB0 ),
  EW_FONT_GLYPH( 0x00ED, 0, -11, 4, 11, 4, 0x00009D0A ),
  EW_FONT_GLYPH( 0x00EE, -1, -11, 5, 11, 4, 0x00009D61 ),
  EW_FONT_GLYPH( 0x00EF, -1, -11, 6, 11, 4, 0x00009DD6 ),
  EW_FONT_GLYPH( 0x00F0, 1, -11, 7, 11, 9, 0x00009E4E ),
  EW_FONT_GLYPH( 0x00F1, 0, -12, 8, 12, 8, 0x00009F93 ),
  EW_FONT_GLYPH( 0x00F2, 0, -11, 9, 11, 9, 0x0000A070 ),
  EW_FONT_GLYPH( 0x00F3, 0, -11, 9, 11, 9, 0x0000A1AF ),
  EW_FONT_GLYPH( 0x00F4, 0, -11, 9, 11, 9, 0x0000A2EB ),
  EW_FONT_GLYPH( 0x00F5, 0, -12, 9, 12, 9, 0x0000A43A ),
  EW_FONT_GLYPH( 0x00F6, 0, -11, 9, 11, 9, 0x0000A595 ),
  EW_FONT_GLYPH( 0x00F7, 0, -10, 9, 9, 9, 0x0000A6DC ),
  EW_FONT_GLYPH( 0x00F8, 0, -9, 9, 10, 9, 0x0000A794 ),
  EW_FONT_GLYPH( 0x00F9, 0, -11, 8, 11, 8, 0x0000A8E5 ),
  EW_FONT_GLYPH( 0x00FA, 0, -11, 8, 11, 8, 0x0000A9A1 ),
  EW_FONT_GLYPH( 0x00FB, 0, -11, 8, 11, 8, 0x0000AA5A ),
  EW_FONT_GLYPH( 0x00FC, 0, -11, 8, 11, 8, 0x0000AB26 ),
  EW_FONT_GLYPH( 0x00FD, 0, -11, 7, 14, 7, 0x0000ABEA ),
  EW_FONT_GLYPH( 0x00FE, 1, -11, 7, 14, 9, 0x0000AD21 ),
  EW_FONT_GLYPH( 0x00FF, 0, -11, 7, 14, 7, 0x0000AE2C ),

  EW_FONT_PIXEL( EwFont_Roboto_HC18_C16, 0x0000AF6E )           /* ratio 73.93 % */
  ...
  EW_FONT_KERNING_CODES( EwFont_Roboto_HC18_C16 )
  EW_FONT_KERNING_VALUES( EwFont_Roboto_HC18_C16 )
EW_END_OF_BITMAP_FONT( EwFont_Roboto_HC18_C16 )
