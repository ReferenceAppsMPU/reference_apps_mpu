...
#define APP_SENSOR_I2C_CLOCK_SPEED      100000  //  400khz

#define PDB_RSENSE_MICRO_CH1  10000    //micro-ohms
#define PDB_RSENSE_MICRO_CH2  10000    //micro-ohms
#define PDB_RSENSE_MICRO_CH3  10000    //micro-ohms
#define PDB_RSENSE_MICRO_CH4  10000    //micro-ohms
...
void PAC1934_Read( void )
{
        ...
        
    {
        ...
        printf("\r\n------------------------------------------------------------------------------------------------------");
        printf("\r\nVDDCORE   -> VBUS1(mV): %4.3f, POWER1(mW): %3.3f, ENERGY1(mWh): %3.3f, CURRENT1(mA): %3.3f", (float)vbus_mVolts[0], (float)(power_mW[0] ), (float)(energy_mWh[0] ), (float)(current_mA[0]));
        printf("\r\nVDDIODDR  -> VBUS2(mV): %4.3f, POWER2(mW): %3.3f, ENERGY2(mWh): %3.3f, CURRENT2(mA): %3.3f", (float)vbus_mVolts[1], (float)(power_mW[1] ), (float)(energy_mWh[1] ), (float)(current_mA[1]));
        printf("\r\nVDD_3R3   -> VBUS3(mV): %4.3f, POWER3(mW): %3.3f, ENERGY3(mWh): %3.3f, CURRENT3(mA): %3.3f", (float)vbus_mVolts[2], (float)(power_mW[2] ), (float)(energy_mWh[2] ), (float)(current_mA[2]));
        printf("\r\nDCDC      -> VBUS4(mV): %4.3f, POWER4(mW): %3.3f, ENERGY1(mWh): %3.3f, CURRENT1(mA): %3.3f", (float)vbus_mVolts[0], (float)(power_mW[0] ), (float)(energy_mWh[0] ), (float)(current_mA[0]));
...
int main ( void )
{
    ...
    printf("sam9x75_cu_pac1934_demo\r\n");
