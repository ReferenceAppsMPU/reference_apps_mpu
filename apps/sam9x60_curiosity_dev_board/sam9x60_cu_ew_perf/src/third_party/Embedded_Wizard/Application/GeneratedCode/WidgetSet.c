...
EW_DEFINE_CLASS( WidgetSetToggleButton, CoreGroup, FlashTimer, textView, Outlet, 
...
EW_DEFINE_CLASS( WidgetSetPushButton, CoreGroup, FlashTimer, textView, OnActivate, 
